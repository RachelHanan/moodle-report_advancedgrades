...
if ($first === false) {
    ...
    redirect($url, get_string('nobtecgrades', 'report_advancedgrades'), 5);
    exit;
}
...
$pos=report_advancedgrades_add_header($workbook, $sheet, $course->fullname, $cm->name, 'btec', $first->btec);
$datacol=$pos;
...
report_advancedgrades_add_data($sheet, $students, $gradinginfopos, 'btec',$datacol);
